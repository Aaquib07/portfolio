  ...
  return (
    <div>
      ...
      <div className='bg-gray-100 text-gray-800 dark:bg-zinc-900 h-screen py-10 mobile:py-6 tablet:py-10 px-6'>
        <div className="max-w-4xl mx-auto flex flex-col gap-8 mobile:gap-2 tablet:gap-6">
          ...
          <div className="bg-rose-200 dark:bg-emerald-900 dark:text-slate-300 shadow-lg rounded-lg p-6 tablet:p-6 mobile:p-2 transition hover:scale-110 duration-300 ease-in-out">
            <ul className="list-disc space-y-2 mobile:space-y-1 pl-5">
