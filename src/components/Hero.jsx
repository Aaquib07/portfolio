...
const Hero = () => {
    return (
        <div className="bg-gray-100 text-gray-800 dark:bg-zinc-900 dark:text-slate-200 h-screen w-full flex tablet:flex-col flex-wrap tablet:gap-2 desktop:gap-20 mobile:gap-10 items-center justify-center tablet:p-8 desktop:p-8 mobile:py-1">
          <div className="flex flex-col justify-start items-start desktop:px-8 mobile:px-1">
            ...
            <h1 className="desktop:text-4xl tablet:text-3xl mobile:text-xl font-bold mb-4">
              I'm <TypeWriterText text={'Aaquib Asrar.'} />
                ...
                <li>
                    <p className="mobile:text-lg desktop:text-xl tablet:text-xl dark:text-slate-300">
            ...
            <div className="flex tablet:w-full tablet:justify-center tablet:ml-0 gap-12 mt-8 mobile:ml-12">
              <Link to={'/about'}>
                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold desktop:text-lg tablet:text-xl desktop:py-3 desktop:px-6 tablet:py-2 tablet:px-3 mobile:px-2 mobile:py-2 rounded-full shadow-md hover:shadow-lg transition duration-300 ease-in-out animate-pulse hover:scale-105">
                  More About Me
                </button>
              </Link>
              <Link to={'/projects'}>
          ...
          <div className="flex-1 flex justify-center items-center">
            <img src={HelloRobot} alt="" className='desktop:h-96 desktop:w-96 tablet:h-80 tablet:w-80 mobile:h-48 mobile:w-48' />
          </div>
        </div>
      );
};
